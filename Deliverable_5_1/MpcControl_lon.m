classdef MpcControl_lon < MpcControlBase
    ...
    methods
        ...
        function ctrl_opti = setup_controller(mpc)
            ...
            load('tube_mpc_data.mat', 'F_tight', 'M_tight', 'f_tight', 'm_tight', 'T_Xf', 't_Xf', 'P', 'T_E', 't_E', 'K', 'Q', 'R');
            ...
            for i = 1:N-1
                ...
                con = [con, F_tight * x(:, i) <= f_tight];
                con = [con, M_tight * u(:, i) <= m_tight];
                obj = obj + x(:, i)' * Q * x(:, i) + u(:, i)' * R * u(:, i);
            end
            con = [con, T_Xf * x(:, N) <= t_Xf];
            obj = obj + x(:, N)' * P * x(:, N);
            ...
            con = con + ( u0 == (K * (delta_x0 - x(:, 1)) +u(:, 1) + mpc.us));
